...
# Check the material of the item
# If material of the item = glass, place item into the glass bin
# Else if material of the item = plastic, place item into the plastic bin
# Else if material of the item = paper, place item into the paper bin
# Else throw it in a non-recycling bin.
...
# have spent:
    ...
    # totalCost = rplates * rcost + bplates * bcost + gplates * gcost
...
if score >= 75:
    ...
    print("Your grade is B, try harder")
elif score >= 50:
    print("Your grade is C, Do better")
else:
    print("Your grade is F, you stupid idiot, you are a disgrace to your parents and you should be expelled and your life will never be good and you will work at McDonalds or KFC and get paid very less and you will have a messed up life.")
